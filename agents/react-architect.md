...
- `device_type: tv`, a TV surface exists, and its implementation model cannot be identified from evidence. (A repository with **no** TV surface is the greenfield path in the dev-planning skill's §14, not a stop condition.)
